    ...
    def __init__(self):
        ...
        self.response_schema = Schema(
            ...
            properties={
                ...
                "owasp_ref": Schema(type="string", description="Platform-specific OWASP mapping(only one from the latest OWASP for the platform in the format OWASP top 10 <year>:<Mx for mobile or Ax for web/API or LLMx for LLM> - <top-10 name>)"),
